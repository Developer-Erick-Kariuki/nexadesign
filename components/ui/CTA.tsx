...
const CTA = () => {
  return (
    <section className="mt-16">
      <div className="bg-white dark:bg-black flex w-full items-center gap-16 max-w-7xl m-auto rounded-4xl">
        <div>
          <Image src="/CTA.svg" width={401} height={200} alt="cta-image" />
        </div>
        <div>
          <h2 className="text-6xl max-w-lg mb-4">Join our news letter</h2>
